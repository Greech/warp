...
/* harmony export */   CanvasManager: () => (/* reexport safe */ _src_canvas_manager__WEBPACK_IMPORTED_MODULE_2__.CanvasManager),
/* harmony export */   Component: () => (/* reexport safe */ _src_models_index__WEBPACK_IMPORTED_MODULE_3__.Component),
...
/* harmony export */   Module: () => (/* reexport safe */ _src_models_index__WEBPACK_IMPORTED_MODULE_3__.Module),
/* harmony export */   System: () => (/* reexport safe */ _src_models_index__WEBPACK_IMPORTED_MODULE_3__.System),
...
/* harmony import */ var _src_canvas_manager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./src/canvas.manager */ "./packages/core/src/canvas.manager.ts");
...
/***/ "./packages/core/src/canvas.manager.ts":
/*!*********************************************!*\
  !*** ./packages/core/src/canvas.manager.ts ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var CanvasManager = /** @class */ (function () {
    ...
    CanvasManager.prototype.getDimension = function () {
        return [
            this.context.canvas.width,
            this.context.canvas.height
        ];
    };
    CanvasManager.prototype.resize = function (_a) {
        var screenWidth = _a[0], screenHeight = _a[1];
        var canvas = this.context.canvas;
        // Set the canvas size to match the screen dimensions
        canvas.width = screenWidth;
        canvas.height = screenHeight;
        // Calculate the scaling factor to maintain the aspect ratio
        var scale = this.getScale(screenWidth, canvas.width, screenHeight, canvas.height);
        // Apply the scaling transformation
        this.context.scale(scale, scale);
        return this;
    };
    CanvasManager.prototype.getScale = function (screenWidth, canvasWidth, screenHeight, canvasHeight) {
...
/* harmony import */ var _injector__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./injector */ "./packages/core/src/injector.ts");
/* harmony import */ var _canvas_manager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./canvas.manager */ "./packages/core/src/canvas.manager.ts");
/* harmony import */ var _entity__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./entity */ "./packages/core/src/entity/index.ts");
 // Import required for metadata
...
var Engine = /** @class */ (function () {
    function Engine(canvasElement) {
        var _this = this;
        this.systems = [];
        // Get all classes in the same module
        this.moduleContext = __webpack_require__("./packages/core/src sync recursive \\.ts$");
        this.moduleFiles = this.moduleContext.keys();
        this.injector = new _injector__WEBPACK_IMPORTED_MODULE_1__.Injector();
        this.entityManager = new _entity__WEBPACK_IMPORTED_MODULE_3__.EntityManager();
        this.canvasManager = new _canvas_manager__WEBPACK_IMPORTED_MODULE_2__.CanvasManager(canvasElement).resize([window.innerWidth, window.innerHeight]);
        this.injector.registerDependency(this.canvasManager);
        this.injector.registerDependency(this.entityManager);
        var systemClasses = this.discoverClasses('ecs:system');
        this.systems = systemClasses.map(function (systemClass) {
            return _this.injector.instantiate(systemClass);
        });
        var entitiesClasses = this.discoverClasses('ecs:entity');
        entitiesClasses.forEach(function (entityClass) {
            _this.entityManager.addEntity(new entityClass());
        });
    }
    ;
    ...
    Engine.prototype.discoverClasses = function (classType) {
        var _this = this;
        var classes = [];
        this.moduleFiles.forEach(function (moduleFile) {
            if (moduleFile === './ecs.engine.ts') {
                return;
            }
            var moduleExports = _this.moduleContext(moduleFile);
            var moduleExportKeys = Object.keys(moduleExports);
            moduleExportKeys.forEach(function (key) {
                var ModuleClass = moduleExports[key];
                if (!_this.isClassType(classType, ModuleClass)) {
                    return;
                }
    ...
    Engine.prototype.isClassType = function (classType, ModuleClass) {
        return Reflect.getMetadata(classType, ModuleClass);
    };
    return Engine;
}());
...
var Entity = function () {
    return function (target) {
        // Store system's constructor in metadata
        Reflect.metadata('ecs:entity', true)(target);
    };
};
...
/* harmony import */ var _game_loop__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./game-loop */ "./packages/core/src/game-loop.ts");

 // Import your existing GameLoop class
var gameInitializer = function (canvasElement) {
    var engine = new _engine__WEBPACK_IMPORTED_MODULE_0__.Engine(canvasElement);
    var gameLoop = new _game_loop__WEBPACK_IMPORTED_MODULE_1__.GameLoop(engine);
    window.warp = {
        engine: engine,
        gameLoop: gameLoop
    };
...
var GameLoop = /** @class */ (function () {
    function GameLoop(ecsEngine) {
        this.lastTimestamp = 0;
        this.ecsEngine = ecsEngine;
        console.log(ecsEngine);
    ...
    GameLoop.prototype.gameLoop = function (timestamp) {
        ...
        this.ecsEngine.update(deltaTime);
        this.requestAnimationFrame();
    };
    GameLoop.prototype.requestAnimationFrame = function () {
...
var Injector = /** @class */ (function () {
    ...
    Injector.prototype.getDependency = function (dependencyClass) {
        ...
        if (!dependency) {
            throw new Error("Missing dependency: ".concat(dependencyClass.name));
        }
        return dependency;
    };
    ...
    Injector.prototype.instantiate = function (classType) {
        var _this = this;
        var dependencies = Reflect.getMetadata('design:paramtypes', classType) || [];
        var resolvedDependencies = dependencies.map(function (dep) { return _this.getDependency(dep); });
...
/***/ "./packages/core/src/models/component.decorator.ts":
/*!*********************************************************!*\
  !*** ./packages/core/src/models/component.decorator.ts ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Component = function (components) {
    return function (target) {
        Reflect.metadata('ecs:components', components)(target);
    };
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Component: () => (/* reexport safe */ _component_decorator__WEBPACK_IMPORTED_MODULE_0__.Component),
/* harmony export */   Module: () => (/* reexport safe */ _module_decorator__WEBPACK_IMPORTED_MODULE_1__.Module),
/* harmony export */   System: () => (/* reexport safe */ _system_decorator__WEBPACK_IMPORTED_MODULE_2__.System)
/* harmony export */ });
/* harmony import */ var _component_decorator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./component.decorator */ "./packages/core/src/models/component.decorator.ts");
/* harmony import */ var _module_decorator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./module.decorator */ "./packages/core/src/models/module.decorator.ts");
/* harmony import */ var _system_decorator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./system.decorator */ "./packages/core/src/models/system.decorator.ts");
...
/***/ "./packages/core/src/models/module.decorator.ts":
/*!******************************************************!*\
  !*** ./packages/core/src/models/module.decorator.ts ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Module = function (_a) {
    var imports = _a.imports, providers = _a.providers, systems = _a.systems, entities = _a.entities;
    return function (target) {
        Reflect.metadata('ecs:module', true)(target);
        Reflect.metadata('ecs:module:imports', imports)(target);
        Reflect.metadata('ecs:module:providers', providers)(target);
        Reflect.metadata('ecs:module:systems', systems)(target);
        Reflect.metadata('ecs:module:entities', entities)(target);
    };
};
...
/***/ "./packages/core/src/models/system.decorator.ts":
/*!******************************************************!*\
  !*** ./packages/core/src/models/system.decorator.ts ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
// SystemDecorator.ts
var System = function (_a) {
    var components = _a.components;
    return function (target) {
        // Store system's constructor in metadata
        Reflect.metadata('ecs:system', true)(target);
        Reflect.metadata('ecs:system:components', components)(target);
    };
};
...
/***/ "./packages/core/src/models/system.model.ts":
/*!**************************************************!*\
  !*** ./packages/core/src/models/system.model.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./packages/core/src sync recursive \\.ts$":
/*!***************************************!*\
...
var map = {
	"./canvas.manager.ts": "./packages/core/src/canvas.manager.ts",
	"./engine.ts": "./packages/core/src/engine.ts",
	"./entity/base-entity.ts": "./packages/core/src/entity/base-entity.ts",
	"./entity/entity.decorator.ts": "./packages/core/src/entity/entity.decorator.ts",
	"./entity/entity.manager.ts": "./packages/core/src/entity/entity.manager.ts",
	"./entity/index.ts": "./packages/core/src/entity/index.ts",
	"./game-initiliazer.ts": "./packages/core/src/game-initiliazer.ts",
	"./game-loop.ts": "./packages/core/src/game-loop.ts",
	"./injector.ts": "./packages/core/src/injector.ts",
	"./models/component.decorator.ts": "./packages/core/src/models/component.decorator.ts",
	"./models/index.ts": "./packages/core/src/models/index.ts",
	"./models/module.decorator.ts": "./packages/core/src/models/module.decorator.ts",
	"./models/system.decorator.ts": "./packages/core/src/models/system.decorator.ts",
	"./models/system.model.ts": "./packages/core/src/models/system.model.ts"
};
...
webpackContext.id = "./packages/core/src sync recursive \\.ts$";
